...
"color: rgb(255, 255, 255);")
        ...
        self.profname_box.setStyleSheet("selection-background-color: rgb(161, 75, 0);")
        ...
        sizePolicy.setHeightForWidth(self.nicknames_combo.sizePolicy().hasHeightForWidth())
        self.nicknames_combo.setSizePolicy(sizePolicy)
        self.nicknames_combo.setMinimumSize(QtCore.QSize(80, 20))
        self.nicknames_combo.setMaximumSize(QtCore.QSize(98, 16777215))
        ...
        self.clear_nicknames_btn.setMinimumSize(QtCore.QSize(98, 0))
        self.clear_nicknames_btn.setMaximumSize(QtCore.QSize(98, 16777215))
...
"border-color: rgb(255, 119, 0);")
        ...
        self.realname_label = QtWidgets.QLabel(self.main_tab)
        self.realname_label.setObjectName("realname_label")
        self.gridLayout_4.addWidget(self.realname_label, 2, 0, 1, 1)
        self.realname_box = QtWidgets.QLineEdit(self.main_tab)
        self.realname_box.setStyleSheet("selection-background-color: rgb(161, 75, 0);\n"
"border-color: rgb(255, 119, 0);")
        self.realname_box.setObjectName("realname_box")
        self.gridLayout_4.addWidget(self.realname_box, 2, 1, 1, 1)
...
"border-color: rgb(255, 119, 0);")
        ...
        self.encoding_label = QtWidgets.QLabel(self.frame_2)
...
"border-color: rgb(255, 119, 0);")
        ...
        self.port_box = QtWidgets.QSpinBox(self.frame_2)
...
"border-color: rgb(255, 119, 0);")
        ...
        self.port_label = QtWidgets.QLabel(self.frame_2)
        ...
        self.requiredssl_cb = QtWidgets.QCheckBox(self.frame_2)
        self.requiredssl_cb.setObjectName("requiredssl_cb")
        self.verticalLayout_6.addWidget(self.requiredssl_cb)
...
"border-color: rgb(255, 119, 0);")
        ...
        self.hostname_box = QtWidgets.QLineEdit(self.ident_tab)
        self.hostname_box.setObjectName("hostname_box")
        self.gridLayout_3.addWidget(self.hostname_box, 1, 1, 1, 1)
        self.hostname_label = QtWidgets.QLabel(self.ident_tab)
        self.hostname_label.setObjectName("hostname_label")
        self.gridLayout_3.addWidget(self.hostname_label, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.realname_label.setText(_translate("Dialog", "Настоящее имя:"))
        ...
        self.requiredssl_cb.setText(_translate("Dialog", "Только SSL-подключение"))
        ...
        self.hostname_label.setText(_translate("Dialog", "Имя хоста:"))
